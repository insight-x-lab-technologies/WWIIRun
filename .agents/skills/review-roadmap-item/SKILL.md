...
- `Changes requested`: use when any acceptance criterion fails, a required gate is missing/failing, or a material finding remains. Set spec and roadmap to `Changes requested`; update `CURRENT_STATE.md` with the next implementation action.
