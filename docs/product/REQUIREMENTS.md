...
- `GAME-02`/`ASSET-01`/`DET-01`/`PERF-01`: [`F1-05`](../specs/SPEC-F1-05-modular-destructible-structure.md) está em revisão: estrutura modular com pool de 16 slots, contatos por módulo e estado/hash v5; os requisitos continuam `Planned` até a vertical slice completa.
