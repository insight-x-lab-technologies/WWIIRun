...
- `PERF-01`: [`F0-06`](../specs/SPEC-F0-06-performance-harness-matrix-budgets.md) adiciona workload, schema, thresholds e matriz reproduzíveis. O requisito permanece `Planned`; baselines físicos e gameplay representativo ainda são necessários.
