...
- `GAME-01`: [`F1-01`](../specs/SPEC-F1-01-gameplay-scene-viewport-input.md), aprovado em revisão independente, implementa a cena de gameplay, tick de integração e contrato comum de teclado/touch com ownership independente; o requisito permanece `Planned` até aeronave, movimento e vertical slice serem implementados e revisados.
