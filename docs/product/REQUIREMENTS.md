...
- `PERF-01`: [`F0-06`](../specs/SPEC-F0-06-performance-harness-matrix-budgets.md) adiciona workload, schema, thresholds e matriz reproduzíveis. Os trios físicos históricos de desktop Windows, iPhone 17 e Galaxy Tab S9 cobrem somente 595/600 segundos e agora são `not-evaluated`; desktop + iPhone precisam de nova coleta com 120 janelas. O requisito permanece `Planned`: o workload é sintético e gameplay representativo ainda precisa ser validado.
