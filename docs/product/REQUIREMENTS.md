...
- `DET-01`: [`F0-04`](../specs/SPEC-F0-04-versioned-prng-seeds-streams.md) entrega seed canônica, PRNG versionado e streams independentes. O requisito permanece `Planned` porque loop, inputs, estado/hash, replay persistido e desafios Daily/Weekly ainda não foram entregues.
