...
- `GAME-08`/`UI-04`/`DET-01`/`PERF-01`: [`F1-08`](../specs/SPEC-F1-08-gameplay-hud.md) está `In review`: implementa HUD de vida, distância técnica, moedas transitórias, FPS local, nível técnico, velocidade e seed como projeção read-only do estado existente. Os requisitos permanecem `Planned` até revisão independente e a vertical slice completa.
