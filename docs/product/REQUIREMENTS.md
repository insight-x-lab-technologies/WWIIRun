...
- `GAME-08`/`UI-04`/`DET-01`/`PERF-01`: [`F1-08`](../specs/SPEC-F1-08-gameplay-hud.md) está `In review`: a correção 1/2 separa a projeção pura do adapter Phaser, preserva datasets após resize e alinha o gate unitário ao schema v6. Os requisitos permanecem `Planned` até revisão independente e a vertical slice completa.
