...
- `GAME-03`/`GAME-09`/`ASSET-01`/`DET-01`/`PERF-01`: [`F1-06`](../specs/SPEC-F1-06-coin-drops-collection-run-statistics.md) está `In review`: drop usa a stream `loot`, coleta e estatísticas transitórias entram no contrato v6, com corpus e gates locais registrados; os requisitos continuam `Planned` até a vertical slice completa.
