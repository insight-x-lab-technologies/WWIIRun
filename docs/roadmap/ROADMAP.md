...
| F0-04 | PRNG versionado, seed parser, streams e golden vectors | F0-02 | Backlog |
| F0-05 | Loop fixo/headless, InputFrame, RunConfig/State e hash | F0-04 | Backlog |
| F0-06 | Performance harness, matriz real e budgets de bundle/assets | F0-02 | Backlog |
| F0-07 | PWA shell offline e preview GitHub Pages em subpath | F0-03 | Backlog |
| F0-08 | Schemas de conteúdo/save e validadores de build | F0-02 | Backlog |
