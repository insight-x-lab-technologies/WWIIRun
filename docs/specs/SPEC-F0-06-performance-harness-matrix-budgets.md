...
- lifecycle: todos os critérios estão atendidos com a exceção histórica explícita do ADR-0007; `PERF-01`, `UI-04` e `ASSET-02` continuam `Planned`. F0-06 está em `In review`, aguardando revisão independente.
