...
- 2026-06-30 — `F0-08-SCHEMA-01`, `F0-08-DIAG-01` e `F0-08-TRACE-01` corrigidos por TDD. Lookup herdado agora falha fechado, diagnósticos de manifest/assets usam índices do arquivo-fonte sem alterar canonicalização e o baseline `2ef8132` separa F0-06 da unidade sucessora F0-08. Critérios 2 e 5 fechados novamente; gates aplicáveis passaram e o item retornou para `In review`, aguardando revisão independente.
